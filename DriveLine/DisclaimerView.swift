...
class DisclaimerView: UIView {
    ...
    class func initWith(title: String, filePath: String? = nil, fileExtension: String? = nil, content: String = "", cancelTitle: String = "Cancel", acceptTitle: String = "Confirm", frame: CGRect = UIScreen.main.bounds, image: String, delegate: DisclaimerViewDelegate) -> DisclaimerView {
        ...
        if image != ""{
            disclaimerView.imgView.setImageWith(URL(string: image)!, placeholderImage: UIImage(named:"drive"))
        }else{
            disclaimerView.imgView.image = #imageLiteral(resourceName: "drive")
        }
